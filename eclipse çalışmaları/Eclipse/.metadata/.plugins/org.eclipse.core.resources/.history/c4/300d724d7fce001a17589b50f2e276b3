	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
			...
			//----------------------GROUP BY ÖZEL KULLANIMI ----------------------
			//countryCode bir string old. için list türünü string aldýk
...
//			
			...
			//----------------------UPDATE ÝÞLEMÝ ----------------------
			/*
			 * City city =session.get(City.class,4086); //4086 TABLODA SEÇÝLEN VERÝNÝN SIRA  NUMARASINA KARÞILIK GELÝYOR
			...
			City city =session.get(City.class,4086);
			 session.delete(city); //4086 ID E SAHÝP SEHÝR SÝLÝNDÝ
			...
			//System.out.println("sehir güncellendi"); //UPDATE
